$(document).ready(function () {
  ...
  function resetSidebarLevels() {
    ...
    $(".sidebar-level:not(.main-level)").css(
      "transition",
  ...
  $(".mobile-menu-toggle, .bottom-navbar .menu-toggle").on(
    "click",
    function () {
  ...
  $(".sidebar-overlay, .close-sidebar").on("click", function () {
    if (
      $(this).hasClass("close-sidebar") &&
      !$(this).closest(".sidebar-level").hasClass("main-level")
    ) {
  ...
  $(".hero-slider").slick({
    ...
    slidesToScroll: 1,
    dots: false,
    arrows: false, // for next/prev button
    infinite: false,
    autoplay: false,
    adaptiveHeight: true,
  });
